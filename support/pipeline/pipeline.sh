...
-t docker.pkg.github.com/queueing-systems-assistance/volantes/volantes:"${RELEASE_VERSION}" . || exit

sudo docker push docker.pkg.github.com/queueing-systems-assistance/volantes/volantes:"${RELEASE_VERSION}" || exit
